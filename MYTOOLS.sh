...
figlet TAUFIQ TOOLS  | lolcat

figlet MY TOOLS  |lolcat

echo -b "_____________________________________________________________" | lolcat
echo -b "TYPE      : TOOLS INSTALLER PREMIUM $green " |lolcat
echo -b "VERSION   : V.3 " | lolcat
echo -b "TOTALS    : 311 TOOLS " | lolcat
echo -b "AUTHOR    : TAUFIQ HAKIM $green " |lolcat
echo -b "ASSOCIATE : MALAYSIA TERMUX ASSOCIATION $green " |lolcat
echo -b "ASSOCIATE : MALAYSIA TERMUX TUTORIAL $green " |lolcat
echo -b "ASSOCIATE : MALAYSIA DARK TERMUX ASSOCIATE $green " |lolcat
echo -b "NOTES     : DOWNLOAD SETIAP TOOLS DENGAN BIJAK " | lolcat
echo -b "_____________________________________________________________" | lolcat
...
ctrl_c() {
clear
echo -b $green"[#]> TOOLS YANG KORANG INSTALL TOOLS TAUFIQ HAKIM " |lolcat
echo -b $green"[#]> Thanks For Using My Tools" |lolcat
sleep 1
echo -b $green"[#]> TAUFIQ HAKIM On Your System" |lolcat
...
echo -e "#######################################" | lolcat
echo -e "#TUNGGU 5 MINIT SAMPAI SEMUA SIAP LOAD#" | lolcat
echo -e "#######################################" | lolcat
...
00) echo "AUTHOR: TAUFIQ HAKIM" | lolcat
echo "LUCIFY EROR IN YOUR SYSTEM" | lolcat
echo "MALAYSIA TERMUX ASSOCIATION" | lolcat
echo "SEMUA TOOLS YANG KORANG INSTALL ADA DI DIRECTORY AKU" | lolcat
figlet MY TOOLS | lolcat
exit
;;

*) echo "Sorry, COMMAND YANG KAU MASUKKAN SALAH SILA TUNGGU LAGI.... [404]"
esac
done
done
