...
###################################################################
'''
     JANGAN RECODE BODO ANJAI SUTUN
'''
###################################################################
#                             COLOR
...
def baliho():
	try:
		...
		print ' ' + W
		print ('O S I F').center(44)
                print ('AOUTHOR      TAUFIQ HAKIM').center(44)
                print ('Name:         OSIF ').center(44)
                print ('codename:     LUCIFY.EROR').center(44)
                print ('version:      full version').center(44)
                print ('date:         27/5/2019').center(44)
                print ('team:          malaysia anonymous').center(44)
                print ('email:         taufiqhakim815@gmail.com').center(44)
                print ('no. phone:     0189710113').center(44)
                print ('IF YOU HAVE AN ANY ISSUES PLEASE CONTACT THE AUTHOR').center(44)
...
def show_program():
 ...
 ------------------------------------------------------
    ...
    CodeName   LUCIFY.EROR
    version    full version
    Date       27/5/2019 3;19
    Team       MALAYSIA ANONYMOUS
    Email      taufiqhakim815@gmail.com
    NO. PHONE   0189710113
